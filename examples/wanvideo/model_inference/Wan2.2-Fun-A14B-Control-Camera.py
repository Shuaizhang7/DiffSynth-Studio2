...
video = pipe(
    ...
    seed=0, tiled=True,
    input_image=input_image,
    camera_control_pose_file="/data/shuaizhang/DiffSynth-Studio/0a0a998c176713fd.txt",
)
save_video(video, "video_from_pose_file_Wan2.2-Fun-A14B-Control-Camera.mp4", fps=15, quality=5)