...
dataset_snapshot_download(
    ...
    local_dir="./",
    allow_file_pattern=f"data/examples/wan/input_image3.jpg"
)
input_image = Image.open("data/examples/wan/input_image3.jpg")
...
video = pipe(
    ...
    camera_control_pose_file="pose/0a45b99f42fb0ecb.txt",
)
save_video(video, "video_pose_file_Wan2.1-Fun-V1.1-1.3B-Control-Camera3.mp4", fps=15, quality=5)
